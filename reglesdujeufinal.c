...
int reglesdujeu(){
    ...
    printf("    - Victoire : pour gagner, il faut que vous recuperiez les 4 oiseaux du niveau. Dans ce cas la, vous passerez directement au niveau suivant.\n"
           "    - Défaite : si vous perdez toutes vos vies, un ecran \"GameOver\" et vous serez redirige vers le menu principal\n\n");
    ...
    printf("    Au cours des niveaux, vous pourrez rencontrer 3 types de blocs : "
           ...
           "        - les blocs pieges : si vous touchez un bloc piege, la partie s'arrete car vous avez perdu.\n\n");

    printf("e. Gestion du temps :\n");
    printf("    Chaque niveau aura un timer initialise a 120 secondes. Si le timer atteint 0, vous perdrez une vie.\n\n");

    printf("f. Méthode de scorification :\n");
    printf("    Outre le fait de reussir un niveau dans le temps imparti, vous aurez un score si vous reussissez. Le score est calcule en fonction du temps restant a la fin du niveau.\n"
    ...
    printf("    A chaque instant, vous pourrez sauvegarder votre partie. Pour cela, vous appuyerez sur la touche \"s\" de votre clavier.\n"
    ...
    printf("i. Mode pause :\n");
    printf("    Pour mettre en pause votre prtie, il faudra appuyer sur la touche \"p\". Ainsi, le timer s'arretera, et il redemarrera si vous appuyez de nouvau sur \"p\".\n\n");
    return 0;
}
